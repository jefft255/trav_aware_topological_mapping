...
output_directory="/media/jft/diskstation/labeling_trav_test"
...
for file in $directory/**/*.bag; do
    ...
    if [[ $filename_without_extension == *"data_20"* ]]; then
        ...
        pid_bag=$!
        playing=true
        sleep 10  # Heading convergence

        # Run the trav dataset creation node, and save to output_dir with the filename of the bag
        python /home/adaptation/jft/catkin_ws/src/topological_mapping/scripts/trav_dataset_creation_node.py "$output_directory/labeling_$filename_without_extension" &
        sleep 5
